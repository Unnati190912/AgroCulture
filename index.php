...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
			                        ...
			                        <div class="3u 12u$(xsmall)">
			                            <input type="password" name="pass_confirm" id="pass_confirm" value="" placeholder="Retype Password" required/>
			                        </div>
								</div>
								<div class="row uniform">
									<div class="6u 12u$(xsmall)">
...
document.addEventListener('DOMContentLoaded', function() {
    // Login form radio buttons (assuming they remain 'farmer' and 'buyer')
    var loginFarmerRadio = document.getElementById('farmer');
    var loginBuyerRadio = document.getElementById('buyer');

    if(loginFarmerRadio && loginBuyerRadio) {
        loginFarmerRadio.addEventListener('change', function() {
            if(this.checked) {
                loginBuyerRadio.checked = false;
            }
        });

        loginBuyerRadio.addEventListener('change', function() {
            if(this.checked) {
                loginFarmerRadio.checked = false;
            }
        });
    }

    // Signup form radio buttons
    var signupFarmerRadio = document.getElementById('signup_farmer');
    var signupBuyerRadio = document.getElementById('signup_buyer');

    if(signupFarmerRadio && signupBuyerRadio) {
        signupFarmerRadio.addEventListener('change', function() {
            if(this.checked) {
                signupBuyerRadio.checked = false;
            }
        });

        signupBuyerRadio.addEventListener('change', function() {
            if(this.checked) {
                signupFarmerRadio.checked = false;
            }
        });
    }
});
